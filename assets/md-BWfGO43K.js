...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-dark":"#666666","--shiki-light":"#999999"}},"}")])])],-1),A={__name:"slides.md__slidev_45",setup(C){const{$slidev:f,$nav:u,$clicksContext:l,$clicks:v,$page:I,$renderContext:x,$frontmatter:n}=y();return l.setup(),($,E)=>{const t=h;return k(),r(g,d(o(e(m)(e(n),44))),{default:a(()=>[B,s("div",D,[p(t,c({},{ranges:["1,4-11,14"]}),{default:a(()=>[_]),_:1},16)])]),_:1},16)}}},b=A;export{b as default};
