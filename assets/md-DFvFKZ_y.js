...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-dark":"#666666","--shiki-light":"#999999"}},"}")])])],-1),A={__name:"slides.md__slidev_46",setup(C){const{$slidev:f,$nav:u,$clicksContext:l,$clicks:v,$page:I,$renderContext:x,$frontmatter:n}=y();return l.setup(),($,N)=>{const t=h;return k(),r(g,d(o(e(D)(e(n),45))),{default:a(()=>[B,s("div",m,[p(t,c({},{ranges:["1,4-9,15"]}),{default:a(()=>[_]),_:1},16)])]),_:1},16)}}},j=A;export{j as default};
